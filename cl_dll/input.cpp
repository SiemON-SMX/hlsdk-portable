...
void IN_PillsDown( void )
{
        // instant-use action, no held state needed server-side
        gEngfuncs.pfnServerCmd( "usepills" );
}
void IN_PillsUp( void )
{
}

void IN_SlowMoDown( void )
{
        gEngfuncs.pfnServerCmd( "toggleslowmo" );
}
void IN_SlowMoUp( void )
{
}
...
void InitInput( void )
{
        ...
        gEngfuncs.pfnAddCommand( "+G", IN_PillsDown );
        gEngfuncs.pfnAddCommand( "-G", IN_PillsUp );
        gEngfuncs.pfnAddCommand( "+shift", IN_SlowMoDown );
        gEngfuncs.pfnAddCommand( "-shift", IN_SlowMoUp );
