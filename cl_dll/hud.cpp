...
// Forward declarations for __MsgFunc wrappers defined via DECLARE_MESSAGE in sub-files
extern int __MsgFunc_EndActiv( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_EndTitle( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_EndTime( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_EndScore( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_EndStat( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_EndCredits( const char *pszName, int iSize, void *pbuf );
extern int __MsgFunc_AimCoords( const char *pszName, int iSize, void *pbuf );
