...
void Game_HookEvents( void )
{
        ...
        // WantedHL weapon events
        gEngfuncs.pfnHookEvent( "events/knife.sc",       EV_WHL_Knife );
        gEngfuncs.pfnHookEvent( "events/pick.sc",        EV_WHL_Pick );
        gEngfuncs.pfnHookEvent( "events/pistol.sc",      EV_WHL_Pistol );
        gEngfuncs.pfnHookEvent( "events/colts.sc",       EV_WHL_Colts );
        gEngfuncs.pfnHookEvent( "events/winchester.sc",  EV_WHL_Winchester );
        gEngfuncs.pfnHookEvent( "events/shotgun.sc",     EV_WHL_Shotgun );
        gEngfuncs.pfnHookEvent( "events/scorpion.sc",    EV_WHL_Scorpion );
        gEngfuncs.pfnHookEvent( "events/gattlinggun.sc", EV_WHL_GattlingGun );
        gEngfuncs.pfnHookEvent( "events/buffalo.sc",     EV_WHL_Buffalo );
        gEngfuncs.pfnHookEvent( "events/bow.sc",         EV_WHL_Bow );
        gEngfuncs.pfnHookEvent( "events/beartrap.sc",    EV_WHL_Beartrap );
}
