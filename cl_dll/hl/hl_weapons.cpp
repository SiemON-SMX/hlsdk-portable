...
// WantedHL weapon placeholder entities (client-side prediction)
CBuffalo g_Buffalo;
CCannon g_Cannon;
CColts g_Colts;
...
CBow g_Bow;
CGattlingGun g_GattlingGun;
CBeartrap g_Beartrap;
