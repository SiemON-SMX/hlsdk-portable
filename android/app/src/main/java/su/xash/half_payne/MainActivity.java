...
public class MainActivity extends Activity {
        ...
        private void startGame(String argv) {
                ...
                intent.putExtra("gamedir", "half_payne");
        ...
        public boolean onOptionsItemSelected(MenuItem menuItem) {
                ...
                if (id == R.id.action_github) {
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/SiemON-SMX/hlsdk-portable/tree/half_payne")));
                        return true;
                }
        ...
        private void showAboutDialog() {
                ...
                if (messageView != null) {
                        messageView.setLinkTextColor(Color.parseColor("#64B5F6"));
