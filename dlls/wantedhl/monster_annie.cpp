...
void CAnnie::BarneyFirePistol(void)
{
        ...
        FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_2DEGREES, 1024, BULLET_MONSTER_9MM, 0, gSkillData.monDmgPistolBullet);
...
void CAnnie::Spawn()
{
        ...
        pev->health = gSkillData.annieHealth;
