...
void W_Precache( void )
{
        ...
        // WantedHL weapons - must be registered FIRST so AmmoInfoArray and ItemInfoArray are populated
        ...
        UTIL_PrecacheOther( "ammo_arrows" );
        ...
        UTIL_PrecacheOther( "ammo_beartraps" );
...
void CBasePlayerWeapon::SendWeaponAnim( int iAnim, int skiplocal, int body )
{
        ...
        // During save/restore the engine sets gpGlobals->pSaveData.
        // Sending SVC_WEAPONANIM (a low-level engine message) while the
        // client is not yet fully (re)connected — as happens during a
        // changelevel — deadlocks Xash3D.  We still update weaponanim so
        // the correct sequence is picked up once the client reconnects.
